...
tasks.register<Jar>("buildPluginJar") {
    archiveFileName.set("boss-plugin-env-inspector-${version}.jar")
    duplicatesStrategy = DuplicatesStrategy.EXCLUDE

    manifest {
        attributes(
            "Implementation-Title" to "BOSS Env Inspector Plugin",
            "Implementation-Version" to version,
            "Main-Class" to "ai.rever.boss.plugin.dynamic.envinspector.EnvInspectorDynamicPlugin"
        )
    }
